...
def plot_model(axis, folder):
	skip = 1
	eps_files = ["eps_tot", "eps_e", "eps_ve", "eps_cr_dis", "eps_cr_sol", "eps_damage", "eps_vp"]
	eps_names = [r"$\varepsilon_{tot}$", r"$\varepsilon_{e}$", r"$\varepsilon_{ve}$", r"$\varepsilon_{cr}$",
				 r"$\varepsilon_{ps}$", r"$\varepsilon_{d}$", r"$\varepsilon_{vp}$"]
	color_names = ["steelblue", "orange", "lightcoral", "violet", "dodgerblue", "mediumseagreen", "tomato"]
...
def main():
	...
	results_folder = os.path.join("output", "case_0", "smp")
