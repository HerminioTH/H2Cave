...
def plot_num(ax1, file_name):
	...
	eps_ie = pd.read_excel(os.path.join(output_folder, "eps_ie.xlsx"))
	...
	ax1.plot(eps_ie["Time"][::step]/hour, 100*abs(eps_ie["22"][::step]), ".-", color="0.15", label=r"$\varepsilon_{v}$", ms=8, mfc="lightcoral")
